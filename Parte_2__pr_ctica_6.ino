...
#define pin_servo 11            //pin11 conectado al servomotor
#define pin_buzz  10            //pin10 conectado al servomotor
#define led_rojo  A2            //pin13 conectao al led rojo
#define led_amar  A1            //pinA1 conectado al led amarillo
#define led_verd  A0            //pinA0 conectado al led verde
...
String contrasenaCerradura = "2023406*";   //Variable donde almaceno la contraseña definida por el sistema
...
void loop()
{
  ...
  if(Serial.available() > 0){
    ...
    info_recibida = info_recibida + serialKey;
